...
`GET /web/session/get_session_info` now returns the full the reference ERP-compatible shape:
...
- Phase 5: IR stubs (`ir.ui.menu`, `ir.ui.view`, `ir.actions`) for full the reference ERP webclient compatibility
