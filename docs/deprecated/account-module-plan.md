...
| Session hardening | ✅ | get_session_info returns full the reference ERP-compatible shape |
...
the reference ERP's account module is 52 models / ~300K lines. We port only what's needed for
...
| Step | C++ Class | the reference ERP model | Table | Key simplification |
|------|-----------|------------|-------|--------------------|
...
## C++ Model Simplifications vs the reference ERP
