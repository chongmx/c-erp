...
**Phase 17b** — `TransferFormView` (stock.picking) — reference-ERP-style form with full workflow buttons,
...
completed with reference-ERP-style breadcrumbs, stepper, two-column info grid, and editable line tables.
