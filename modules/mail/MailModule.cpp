...
// ================================================================
// MailModule method definitions
// ================================================================

MailModule::MailModule(core::ModelFactory&     modelFactory,
...
std::string MailModule::moduleName() const { return "mail"; }
std::string MailModule::version()    const { return "17.0.1.0.0"; }
std::vector<std::string> MailModule::dependencies() const { return {"auth"}; }

void MailModule::registerModels()   {}
void MailModule::registerServices() {}
void MailModule::registerViews()    {}
void MailModule::registerRoutes()   {}

void MailModule::registerViewModels() {
...
void MailModule::initialize() {
    ensureSchema_();
}

void MailModule::ensureSchema_() {
