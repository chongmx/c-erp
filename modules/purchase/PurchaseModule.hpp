...
public:
    static constexpr const char* staticModuleName() { return "purchase"; }

    explicit PurchaseModule(ModelFactory&     modelFactory,
    ...
    std::string              moduleName()   const override { return "purchase"; }
...
private:
    ...
    void seedMenus_() {
        ...
        // ir_act_window id=12: Purchase Orders
        txn.exec(R"(
        ...
        // Level 0 — Purchase app tile (id=70, parent=NULL)
        txn.exec(R"(
        ...
        // Level 1 — Orders section (id=71, parent=70, no action — has children)
        txn.exec(R"(
        ...
        // Level 2 — Purchase Orders leaf (id=72, parent=71, action_id=12)
        txn.exec(R"(
            INSERT INTO ir_ui_menu (id, name, parent_id, sequence, action_id)
