...
// ================================================================
// 3. UomModule method definitions
// ================================================================

UomModule::UomModule(core::ModelFactory&     models,
...
std::string UomModule::moduleName() const { return "uom"; }

void UomModule::registerModels() {
    auto db = services_.db();
    models_.registerCreator("uom.uom", [db]{ return std::make_shared<UomUom>(db); });
}

void UomModule::registerServices() {}

void UomModule::registerViewModels() {
    auto db = services_.db();
...
void UomModule::registerRoutes() {}

void UomModule::initialize() {
    ensureSchema_();
    seedUom_();
    seedMenus_();
}
