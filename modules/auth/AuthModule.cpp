...
// ================================================================
class AuthModule::CompanyViewModel : public core::BaseViewModel {
public:
...
// ================================================================
class AuthModule::GroupsViewModel : public core::BaseViewModel {
public:
...
// ================================================================
// AuthModule — constructor and IModule method implementations
// ================================================================

AuthModule::AuthModule(core::ModelFactory&     modelFactory,
...
std::string AuthModule::moduleName() const { return "auth"; }
std::string AuthModule::version()    const { return "19.0.1.0.0"; }
std::vector<std::string> AuthModule::dependencies() const { return {"base"}; }

void AuthModule::registerModels() {
...
void AuthModule::registerServices() {
    auto db = services_.db();
...
void AuthModule::registerViewModels() {
    auto& sf  = services_;
    auto& vf  = views_;
    auto  db  = services_.db();
...
void AuthModule::registerRoutes() {}
...
// ----------------------------------------------------------
// ensureSchema_ — idempotent DDL
// ----------------------------------------------------------
void AuthModule::ensureSchema_() {
...
// ----------------------------------------------------------
// seedGroups_ — idempotent
// ----------------------------------------------------------
void AuthModule::seedGroups_() {
    auto conn = services_.db()->acquire();
    pqxx::work txn{conn.get()};
...
// ----------------------------------------------------------
// seedGroupPermissions_ — only writes rows still at default '[]'
// ----------------------------------------------------------
void AuthModule::seedGroupPermissions_() {
...
// ----------------------------------------------------------
// seedAdminUser_ — idempotent
// ----------------------------------------------------------
void AuthModule::seedAdminUser_() {
    auto conn = services_.db()->acquire();
    pqxx::work txn{conn.get()};
