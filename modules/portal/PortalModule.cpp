...
// ================================================================
// PortalModule — method implementations
// ================================================================

PortalModule::PortalModule(core::ModelFactory&     /*modelFactory*/,
...
std::string PortalModule::version()    const { return "19.0.1.0.0"; }

std::vector<std::string> PortalModule::dependencies() const {
    return {"base", "account", "product"};
}

void PortalModule::registerModels()   {}
void PortalModule::registerServices() {}
void PortalModule::registerViews()    {}

// ----------------------------------------------------------
// registerViewModels
// ----------------------------------------------------------
void PortalModule::registerViewModels() {
    auto db = db_;
...
// ----------------------------------------------------------
void PortalModule::registerRoutes() {
    auto db              = db_;
...
// Schema (idempotent)
// ----------------------------------------------------------
void PortalModule::ensureSchema_() {
    auto conn = db_->acquire();
    pqxx::work txn{conn.get()};
...
// Upload directory
// ----------------------------------------------------------
void PortalModule::ensureUploadDir_() {
